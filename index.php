     ...
     <?php  if(!isset($_SESSION['customer_email'])){
       ...
       <div id="TopRightCart">
        ...
        <div id="MiddlePart"> <!-- Site Middle Part-->
            ...
            <div class="slider"><!-- Site Middle Slider Part-->
            <div class="sliderShow">
                <img src="images/Veg4.jpg">
                <img src="images/Veg5.jpg">
                <img src="images/Fruits1.jpg">
            ...
            $get_products = "SELECT * FROM product where Product_tittle LIKE '%$search_queries%'";
