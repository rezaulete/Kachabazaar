     ...
     <?php  if(!isset($_SESSION['customer_email'])){
       ...
       <div id="TopRightCart">
        ...
        <div id="MiddlePart"> <!-- Site Middle Part-->    
             ...
             <div class="offerBox">
                 <div class="offerboxleft">
                        <img src="images/potato.jpg">                
                 </div>
                 <div class="FreeText"><h1>20%FREE</h1></div>
                 <div class="offerboxright">
                 <div class="Productsingle">
                    <div class="ProdutImage">
                       <img src="images/potato.jpg" height="100px">
                     ...
                     <p>
                         Reguler size (net weight: &plusmn;50gm )
                    </p>
                     </div>
                     ...
                     <div class="Cartbutton" style="width:90%">
                         <a href="#">Add to Cart</a>
                     </div>
                 </div><!-- Product One Part end-->
             ...
             <div class="offerBox">
                 ...
                 <div class="Productsingle">
                    <div class="ProdutImage">
                       <img src="images/Tomato.jpg" height="100px">
                     ...
                     <div class="ProductDesc">
                     <p>
                         Reguler size (net weight: &plusmn;20gm )
                    </p>
                     </div>
                 ...
                 <div class="offerboxright">
                              <div class="Productsingle">
                    <div class="ProdutImage">
                       <img src="images/Cabbage.png" height="100px">
                     ...
                     <div class="ProductDesc">
                     <p>
                         Reguler size (net weight: &plusmn;2kg )
                    </p>
                     </div>
