...
while($row_products=mysqli_fetch_array($run_products)){
    ...
    $products_des=$row_products['Product_description'];
    
       echo "<div id='products_Details'>
       <h1>$products_title</h1>
	   <div id='products_Details_Left'>
       <img src='Admin/product_images/$products_image' width='300px' height='300px'>
	   </div>
	   <div id='products_Detail_Right'>
	   
       <h2>BDT $products_price</h2>
	    <p>$products_des</p>
       <a href='index.php' style='float:left;'>Back</a>
       <a href='index.php?products_id=$products_id' >
